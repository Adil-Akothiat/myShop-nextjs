    ...
    return (
        ...
        <section>
            <div className="grid md:grid-cols-2">
                <div className="border text-center bg-slate-700 text-white uppercase p-5 relative h-80 md:h-full rounded-b-lg md:rounded-none md:rounded-l-lg order-2 md:order-none">
